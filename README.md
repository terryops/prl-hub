...
- **Chain data** comes from Pearl's public Blockbook indexer (`blockbook.pearlresearch.ai`), which also broadcasts signed transactions. The app has no backend of its own.
